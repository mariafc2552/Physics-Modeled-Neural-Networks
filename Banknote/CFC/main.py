...
def _evaluate_epoch(
    ...
    *,
    ...
    """
    Evaluate one epoch for Banknote Authentication binary classification with CfC.

    The CfC model returns logits:
...
def fit(
    ...
    *,
    ...
    """
    Train, validate and test a CfC model for Banknote Authentication binary
    classification.
...
if __name__ == "__main__":
    ...
    baserundir = os.path.join(rootdir, "runs_cfc_banknote")
    ...
    for num_units in num_units_values:
        for batch_size in batch_size_values:
            for lr in lr_values:
                ...
                config_name = (
                    f"cfc_units_{tag_value(num_units)}"
