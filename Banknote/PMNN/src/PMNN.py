...
class PMNNBlock(nn.Module):
    """
    FitzHugh--Nagumo-based PMNN for Banknote Authentication classification.

    The Banknote Authentication dataset has:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            * input_size: number of input features. For Banknote Authentication,
              use 4.
            * hidden_size: size of the pre-dynamical embedding. For a 2D FHN
              PMNN, use 2.
            * output_size: number of classes. For Banknote Authentication, use 2.
