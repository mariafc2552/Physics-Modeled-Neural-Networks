...
def _evaluate_epoch(
    ...
    *,
    ...
    """
    Evaluate one epoch for binary classification with CfC.
...
def fit(
    ...
    *,
    ...
    """
    Train, validate and test a CfC model for Breast Cancer binary classification.
...
if __name__ == "__main__":
    ...
    baserundir = os.path.join(rootdir, "runs_cfc_breast_cancer")
    ...
    num_units_values: Sequence[int] = as_list(
        config["model"].get("num_units_values", [64])
    )
