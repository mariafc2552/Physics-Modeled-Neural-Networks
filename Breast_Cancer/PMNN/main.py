...
def _evaluate_epoch(
    ...
    *,
    ...
    """
    Evaluate one epoch for binary classification.
...
def fit(
    ...
    *,
    ...
    """
    Train, validate and test a FitzHugh--Nagumo PMNN for binary classification.
...
if __name__ == "__main__":
    ...
    baserundir = os.path.join(rootdir, "runs_pmnn_breast_cancer")
    ...
    input_size = int(config["model"].get("input_size", 30))
