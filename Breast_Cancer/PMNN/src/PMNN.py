...
class PMNNBlock(nn.Module):
    """
    FitzHugh--Nagumo-based PMNN for Breast Cancer Wisconsin classification.

    The Breast Cancer Wisconsin Diagnostic dataset has:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            * input_size: number of input features. For Breast Cancer, use 30.
            * hidden_size: size of the pre-dynamical embedding. For a 2D FHN
              PMNN, use 2.
            * output_size: number of classes. For Breast Cancer, use 2.
