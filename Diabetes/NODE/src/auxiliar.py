...
def save_loss_curves(epoch_losses, val_losses, batch_size, lr, hidden_dimension, num_layer, results_folder):
    """
    ...
    plt.title(
        ...
        f"batch_size = {batch_size}, lr = {lr}, num_layer = {num_layer}, hidden_dim = {hidden_dimension}",
    ...
    filename = os.path.join(
        results_folder,
        f"batch_size_{batch_size}_lr_{lr}_num_layer_{num_layer}_hidden_dim_{hidden_dimension}_loss_graph.png"
    )
