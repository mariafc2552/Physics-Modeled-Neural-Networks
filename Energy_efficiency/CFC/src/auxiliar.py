...
def save_loss_curves(epoch_losses, val_losses, num_units, batch_size, lr, results_folder):
    """
    ...
    Inputs:
        ...
        * num_units: number of neurons in the CFC.
    ...
    plt.title(
        ...
        f"num_units={num_units}, batch_size={batch_size}, lr={lr}",
    ...
    filename = os.path.join(
        results_folder,
        f"num_units_{num_units}_batch_size_{batch_size}_lr_{lr}_loss_graph.png"
    )
