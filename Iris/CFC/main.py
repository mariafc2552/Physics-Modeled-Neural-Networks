...
def _evaluate_epoch(
    ...
    *,
    ...
    """
    Evaluate one epoch for Iris multi-class classification with CfC.
...
def fit(
    ...
    *,
    ...
    """
    Train, validate and test a CfC model for Iris multi-class classification.
...
if __name__ == "__main__":
    ...
    baserundir = os.path.join(rootdir, "runs_cfc_iris")
