...
class CFCblock(nn.Module):
    """
    Closed-form Continuous-time Neural Network for Iris multi-class
    classification.
    ...
    Therefore, each flower/sample is interpreted as a sequence with one
    artificial time step and 4 input features.
    ...
    For Iris classification with CrossEntropyLoss:
        ...
        *,
        ...
        Args:
            ...
            * output_size: number of output classes.
              For Iris with CrossEntropyLoss, use 3.
    ...
    def _prepare_sequence(self, x: torch.Tensor) -> torch.Tensor:
        """
        Prepare Iris tabular data for CfC.
